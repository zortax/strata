...
pub(super) fn get(conn: &Connection, z: u8, x: u32, y: u32) -> Result<Option<Vec<u8>>, StoreError> {
...
pub(super) fn put(conn: &Connection, z: u8, x: u32, y: u32, png: &[u8]) -> Result<(), StoreError> {
    conn.execute(
